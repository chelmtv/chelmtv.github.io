...
export declare type Caption = ContentCaption | MetaCaption | StyleCaption;
...
export declare type ConvertOptions = ParseOptions & {
    to: string;
...
export declare type BuildFunction = (captions: Caption[], options: BuildOptions) => string;
export declare type DetectFunction = (content: string) => boolean | string;
export declare type ParseFunction = (content: string, options: ParseOptions) => Caption[];
