...
} from "./chunk-CT2ADGH4.js";
import "./chunk-TKHKC6ZS.js";
import "./chunk-MCOBMQLI.js";
import "./chunk-PCTKPE4V.js";
import "./chunk-3AHHDSZC.js";
import "./chunk-YCMLTQBQ.js";
import "./chunk-IIJ2FYC7.js";
import "./chunk-3C36ZEHD.js";
import "./chunk-IQHEENQG.js";
import "./chunk-367FHU5D.js";
import "./chunk-TYSKS5M3.js";
import "./chunk-JVLZN3LB.js";
import "./chunk-G6PODNB4.js";
import "./chunk-RCSXG2HZ.js";
import "./chunk-U3I62X7R.js";
import "./chunk-6JPC5XMY.js";
import {
  require_react
} from "./chunk-ZPI53U7Z.js";
import {
  __commonJS,
  __toESM
...
var import_es_reflect_construct = __toESM(require_es_reflect_construct());
var import_es_object_define_property = __toESM(require_es_object_define_property());
...
var options;
var supportPassiveEvent_default = passiveSupported;

// node_modules/subscribe-ui-event/dist-es/globalVars.js
var globalVars_default = {
  connections: {},
  EE: new import_eventemitter3.default(),
  enableResizeInfo: false,
  enableScrollInfo: false,
  listeners: {},
  removers: [],
  supportPassiveEvent: supportPassiveEvent_default
};

// node_modules/subscribe-ui-event/dist-es/lib/listen.js
var supportPassiveEvent = globalVars_default.supportPassiveEvent;
...
function listen(target, eventType, handler, options) {
  ...
  var type = eventType;
  var eventOptions = supportPassiveEvent ? (0, import_assign.default)({}, defaultEventOption, options) : false;
...
if (typeof navigator !== "undefined") {
  matches = navigator.userAgent.match(/MSIE (\d+\.\d+)/);
  if (matches) {
    leIE8 = parseFloat(matches[1], 10) < 9;
  }
}
var matches;
var leIE8_default = leIE8;
...
var getXY = function getXY2(pos) {
  var t = { x: 0, y: 0 };
  var docBody2 = document.body;
  var docEl2 = document.documentElement;
  if (pos.pageX || pos.pageY) {
    t.x = pos.pageX;
    t.y = pos.pageY;
  } else {
    t.x = pos.clientX + docBody2.scrollLeft + docEl2.scrollLeft;
    t.y = pos.clientY + docBody2.scrollTop + docEl2.scrollTop;
  }
  return t;
};
var AugmentedEvent = function() {
  function AugmentedEvent2() {
    var option = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    _classCallCheck(this, AugmentedEvent2);
  ...
  _createClass(AugmentedEvent2, [{
    key: "update",
    value: function update(e) {
      var mainType = this.mainType, subType = this.subType;
      var docEl2 = document.documentElement;
      if (globalVars_default.enableScrollInfo && (mainType === "scroll" || mainType === "touchmove")) {
        var top = docEl2.scrollTop + document.body.scrollTop;
        if (top !== this.scroll.top) {
          this.scroll.delta = top - this.scroll.top;
          this.scroll.top = top;
        }
      }
      if (globalVars_default.enableResizeInfo && mainType === "resize") {
        this.resize.width = window.innerWidth || docEl2.clientWidth;
        this.resize.height = window.innerHeight || docEl2.clientHeight;
      }
      if (globalVars_default.enableTouchInfo && e.touches && (mainType === "touchstart" || mainType === "touchmove" || mainType === "touchend")) {
        var pos = void 0;
        var absX = void 0;
        var absY = void 0;
  ...
  return AugmentedEvent2;
}();
var AugmentedEvent_default = AugmentedEvent;

// node_modules/subscribe-ui-event/dist-es/lib/rAFThrottle.js
var import_raf = __toESM(require_raf());
var getTime = Date.now || /* istanbul ignore next */
function() {
  return (/* @__PURE__ */ new Date()).getTime();
};
function rAFThrottle(func) {
  var throttle2 = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 15;
  var context = void 0;
  var args = void 0;
  var last = 0;
  var requestId = 0;
  var later = function later2() {
    var now = getTime();
    var remaining = throttle2 - (now - last);
    if (remaining <= 0) {
      last = now;
      requestId = 0;
      func.apply(context, args);
    } else {
      requestId = (0, import_raf.default)(later2);
    }
  };
  return function throttledFunc() {
    ...
    args = arguments;
    if (!requestId) {
      requestId = (0, import_raf.default)(later);
    }
  };
}
var rAFThrottle_default = rAFThrottle;
...
// node_modules/subscribe-ui-event/dist-es/mainEventConnectors.js
var connections = globalVars_default.connections;
var EE = globalVars_default.EE;
var listeners = globalVars_default.listeners;
var removers = globalVars_default.removers;
var doc = void 0;
var win = void 0;
var body = void 0;
var hashId = 0;
...
function connectThrottle(throttledEvent, cb, ctx, throttledMainEvent) {
  EE.on(throttledEvent, cb || import_noop.default, ctx);
  ...
  return {
    ...
    unsubscribe: function unsubscribe() {
      ...
      if (connections[throttledMainEvent] === 0) {
        ...
        listeners[throttledMainEvent] = void 0;
      }
      this._type = void 0;
      this._cb = void 0;
      this._ctx = void 0;
...
function connectContinuousEvent(target, mainEvent, event) {
  return function throttleEvent(throttleRate, cb, options, eventOptions) {
    ...
    var ae = {
      start: new AugmentedEvent_default({ mainType: mainEvent, subType: "start" }),
      // start
      main: new AugmentedEvent_default({ mainType: mainEvent }),
      // main
      end: new AugmentedEvent_default({ mainType: mainEvent, subType: "end" })
    };
    if (throttleRate === "raf") {
      throttleRate = 16;
      handler = rAFThrottle_default(handler);
    } else if (throttleRate > 0) {
      handler = (0, import_throttle.default)(handler, throttleRate);
    }
    var timer = void 0;
    ...
    function handler(e) {
      ...
      if (!leIE8_default) {
        ...
        timer = setTimeout(function() {
          endCallback((0, import_clone.default)(e));
        }, throttleRate + EVENT_END_DELAY);
      }
    }
    listeners[throttledMainEvent] = listen_default(domTarget || target, mainEvent, handler, eventOptions);
    return remover;
  };
}
function connectDiscreteEvent(target, event) {
  return function throttleEvent(throttleRate, cb, options, eventOptions) {
    ...
    var ae = new AugmentedEvent_default({ mainType: event });
    function handler(e) {
      ae.update(e);
      EE.emit(throttledEvent, e, ae);
    }
    listeners[throttledEvent] = listen_default(domTarget || target, event, handler, eventOptions);
    return remover;
  };
}
var mainEventConnectors_default = {
...
function subscribe(type, cb) {
  ...
  globalVars_default.enableScrollInfo = globalVars_default.enableScrollInfo || options.enableScrollInfo || false;
  globalVars_default.enableResizeInfo = globalVars_default.enableResizeInfo || options.enableResizeInfo || false;
  globalVars_default.enableTouchInfo = globalVars_default.enableTouchInfo || options.enableTouchInfo || false;
  return mainEventConnectors_default[type](throttleRate, cb, options, eventOptions);
}
var subscribe_default = subscribe;

// node_modules/subscribe-ui-event/dist-es/unsubscribe.js
var removers2 = globalVars_default.removers;
...
var subscribe2 = IS_CLIENT ? subscribe_default : warn;
...
var STATUS_ORIGINAL = 0;
var STATUS_RELEASED = 1;
var STATUS_FIXED = 2;
var TRANSFORM_PROP = "transform";
var doc2;
var docBody;
var docEl;
var canEnableTransforms = true;
var M;
var scrollDelta = 0;
var win2;
var winHeight = -1;
var Sticky = function(_Component) {
  ...
  function Sticky2(props, context) {
    var _this;
    _classCallCheck2(this, Sticky2);
  ...
  _createClass2(Sticky2, [{
    ...
    value: function getTopPosition(top) {
      ...
      if (typeof top === "string") {
        if (!this.topTarget) {
          this.topTarget = doc2.querySelector(top);
        }
    ...
    value: function getBottomBoundary(bottomBoundary) {
      ...
      if (typeof boundary === "string") {
        if (!this.bottomBoundaryTarget) {
          this.bottomBoundaryTarget = doc2.querySelector(boundary);
        }
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var arePropsChanged = !(0, import_shallowequal.default)(this.props, prevProps);
      if (arePropsChanged) {
    ...
    value: function componentDidMount() {
      if (!win2) {
        win2 = window;
        doc2 = document;
        docEl = doc2.documentElement;
        docBody = doc2.body;
        winHeight = win2.innerHeight || docEl.clientHeight;
        M = window.Modernizr;
        if (M && M.prefixed) {
      ...
      this.subscribers = [subscribe2("scrollStart", this.handleScrollStart.bind(this), {
        useRAF: true
      }), subscribe2("scroll", this.handleScroll.bind(this), {
        useRAF: true,
        enableScrollInfo: true
      }), subscribe2("resize", this.handleResize.bind(this), {
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return !this.props.shouldFreeze() && !((0, import_shallowequal.default)(this.props, nextProps) && (0, import_shallowequal.default)(this.state, nextState));
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var outerClasses = (0, import_classnames.default)("sticky-outer-wrapper", this.props.className, (_classNames = {}, _defineProperty(_classNames, this.props.activeClass, this.state.status === STATUS_FIXED), _defineProperty(_classNames, this.props.releasedClass, this.state.status === STATUS_RELEASED), _classNames));
      var innerClasses = (0, import_classnames.default)("sticky-inner-wrapper", this.props.innerClass, _defineProperty({}, this.props.innerActiveClass, this.state.status === STATUS_FIXED));
...
Sticky.propTypes = {
  ...
  top: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.number]),
  bottomBoundary: import_prop_types.default.oneOfType([
    import_prop_types.default.object,
    // TODO, may remove
    import_prop_types.default.string,
    import_prop_types.default.number
  ]),
  enableTransforms: import_prop_types.default.bool,
  activeClass: import_prop_types.default.string,
  releasedClass: import_prop_types.default.string,
  innerClass: import_prop_types.default.string,
  innerActiveClass: import_prop_types.default.string,
  className: import_prop_types.default.string,
  onStateChange: import_prop_types.default.func,
  shouldFreeze: import_prop_types.default.func,
  innerZ: import_prop_types.default.oneOfType([import_prop_types.default.string, import_prop_types.default.number])
};
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=react-stickynode.js.map
